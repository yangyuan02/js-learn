<!--
 * @Author: yangyuan
 * @Date: 2020-06-02 10:52:12
 * @Email: 1367511704@qq.com
 * @LastEditTime: 2020-06-02 10:52:13
 * @Description: <script>
/**
  使用说明：
  属性            类型          作用                                                 案例
...
<template>
  <div class="sd-search-form">
    <el-form ref="form" :model="formModel" :inline="false" :label-width="formLayouts.labelWidth">
      <el-row :gutter="formLayouts.gutter">
        <el-col :sm="12" :md="8" :lg="6"
          ...
          <transition name="el-zoom-in-top">
            ...
            <!-- type === input-->
            <el-col :span="formItem.colSpan || defaultColSpan" v-if="formItem.controlName === 'input'">
              <el-input
            ...
            <!-- type === select -->
            <el-col :span="formItem.colSpan || defaultColSpan" v-else-if="formItem.controlName === 'select'">
              <el-select
                v-model="formModel[formItem['model']]"
                :placeholder="formItem.placeholder"
                :clearable="formItem.clearable"
            ...
            <!-- type === datePicker -->
            <el-col :span="formItem.colSpan || defaultColSpan" v-else-if="formItem.controlName === 'datePicker'">
              <el-date-picker
                v-model="formModel[formItem['model']]"
                :type="formItem.type"
                :placeholder="formItem.placeholder"
            ...
            <!-- type === switch -->
            <el-col :span="formItem.colSpan || defaultColSpan" v-else-if="formItem.controlName === 'switch'">
              <el-switch
                v-model="formModel[formItem['model']]"
                :active-text="formItem.activeText || ''"
                :inactive-text="formItem.inactiveText || ''"
                :active-color="formItem.activeColor || '#409EFF'"
                :inactive-color="formItem.inactiveColor || '#C0CCDA'"
            ...
            <!-- type === checkbox-group -->
            <el-col :span="formItem.colSpan || defaultColSpan" v-else-if="formItem.controlName === 'checkbox-group'">
              <el-checkbox-group
                  v-model="formModel[formItem['model']]"
                  @change="controlChange(formItem['model'])"
                >
                <el-checkbox
                  v-for="(checkbox, index) in formItem.checkboxes"
      ...
      <el-row :gutter="formLayouts.gutter">
        <div class="sd-search-form-operation">
          <div class="sd-search-form-btn" style="flex: 1">
            ...
            <span class="search_button" style="margin-left:10px" @click="search">查询</span>
          </div>
          <div class="left_span sd-search-form-expand" style="flex: 0 0 50px" @click="toggleSearch" v-if="showHiddenParts">
            <div v-if="toggleSearchParts === 'up'"><i class="upArrow"></i><br />收起</div>
            <div v-else-if="toggleSearchParts === 'down'"><i class="downArrow"></i><br />展开</div>
          </div>
        </div>
      </el-row>
    </el-form>
